    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exercise', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='exercise_histories', to='exercises.exercise')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('user', 'exercised_at', 'order'), name='unique_user_exercised_at_order', violation_error_message='사용자의 운동 루틴은 순번을 중복해서 가질 수 없습니다.'),
        ),
        migrations.AddConstraint(
