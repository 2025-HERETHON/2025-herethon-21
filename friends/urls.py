...
urlpatterns = [
    ...
    path('accept/<str:notification_id>/', create_accept_friend, name="create_accept_friend"),
    path('reject/<str:notification_id>/', create_reject_friend, name="create_reject_friend"),
